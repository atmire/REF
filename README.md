...
**__Important note__**: This patch applies modifications to your DSpace source code. Before applying any patch to DSpace source code, it is **always** recommended to create a backup of your DSpace source code.
