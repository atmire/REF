 ...
 * Time: 17:37
 */
public class REFItemComplianceMain extends AbstractDSpaceTransformer {
    ...
    private ComplianceUI complianceUI = new DSpace().getServiceManager().getServiceByName("refComplianceUI", ComplianceUI.class);
