 ...
 * Time: 16:21
 */
public class RIOXXComplianceAction extends AbstractXMLUIAction {

    private static final Message T_HEAD = message("xmlui.compliance.workflow.RIOXXComplianceAction.head");
    ...
    public void addBody(Body body) throws SAXException, WingException, SQLException, IOException, AuthorizeException {
        ...
        ComplianceUI complianceUI = new DSpace().getServiceManager().getServiceByName("rioxxComplianceUI", ComplianceUI.class);
