...
public class DescribeStep extends AbstractProcessingStep
{
            ...
            AuthorizeException
    {
        ...
        String documentType = "";
        if(org.apache.commons.lang3.StringUtils.isNotBlank(typeField) && (item.getMetadata(typeField) != null) && (item.getMetadata(typeField).length >0) )
        {
            documentType = item.getMetadata(typeField)[0].value;
        }
